...
// Form 表单提交参数
func (c *HttpClient) Form(form url.Values) *HttpClient {
...
func (c *HttpClient) Json(json interface{}) *HttpClient {
...
func (c *HttpClient) Multipart(multipart FileForm) *HttpClient {
	c.multipart = multipart
	return c
}

// Send 发送http请求
func (c *HttpClient) Send() *Result {
	var result *Result
...
func (c *HttpClient) createMultipartForm() *Result {
...
func (c *HttpClient) createJson() *Result {
	var result = new(Result)
...
func (c *HttpClient) createForm() *Result {
	var result = new(Result)
...
func (c *HttpClient) createEmptyBody() *Result {
	var result = new(Result)
...
// doSend 发送请求
func (c *HttpClient) doSend(req *http.Request, result *Result) {
	// 调用拦截器，遇到错误就退出
...
func (c *HttpClient) beforeSend(req *http.Request) error {
...
// newClient 创建Client
func newClient(u string, method string, client *http.Client) *HttpClient {
